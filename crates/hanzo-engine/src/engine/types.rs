...
impl ProviderKind {
    pub fn default_base_url(&self) -> &str {
        match self {
            ...
            // Claude Code CLI: no URL needed — spawns the `claude` binary.
            // base_url field is repurposed as the path to the claude binary.
            ProviderKind::ClaudeCode => "",
            // External: host app provides the URL via ProviderConfig.base_url
...
impl Default for EngineConfig {
    fn default() -> Self {
        EngineConfig {
            ...
            default_model: None,
            default_system_prompt: Some(r#"You are a powerful AI agent running in Hanzo — a desktop AI assistant with full access to the user's machine.
